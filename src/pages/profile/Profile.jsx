...
import { FaUser, FaEnvelope, FaCalendarAlt, FaSignOutAlt, FaShieldAlt, FaChartPie } from 'react-icons/fa';
            ...
            <div className="glass p-6 rounded-3xl border border-slate-800">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-white text-xs">{joinDate}</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="glass p-8 rounded-3xl border border-slate-800">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-2 italic">Verified via Firebase Authentication</p>
                </div>

                <div className="pt-4 border-t border-slate-800/50">
                  <h4 className="font-medium text-slate-300 mb-2">Password Management</h4>
                  <p className="text-sm text-slate-500 mb-4">
                    To change your password or update security settings, please use the reset link sent to your email.
                  </p>
            ...
            <div className="bg-gradient-to-br from-indigo-600/10 to-purple-600/10 p-8 rounded-3xl border border-indigo-500/10">
              ...
              <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                As an ExpenseAI user, you have access to personalized AI financial advice and secure data backups.
              </p>
              <div className="flex gap-4">
                <div className="flex-1 bg-slate-900/50 p-4 rounded-2xl text-center">
                  ...
                  <div className="text-[10px] text-slate-500 uppercase tracking-tighter">Uptime</div>
                </div>
                <div className="flex-1 bg-slate-900/50 p-4 rounded-2xl text-center">
                  <div className="text-2xl font-bold text-purple-400">SSL</div>
                  <div className="text-[10px] text-slate-500 uppercase tracking-tighter">Encrypted</div>
                </div>
              </div>
            </div>
          </motion.div>
